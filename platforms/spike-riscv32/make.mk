...
include $(bao_demos)/platforms/spike.mk
# include $(bao_demos)/platforms/opensbi.mk # add somthing instead of modify other files
include $(bao_demos)/platforms/opensbi-spike-riscv32.mk
