...
$(scfw):
	...
	cp /home/david/Documents/PARA/1-Projects/wipro/imx8qm/android-build/android_build/vendor/nxp/fsl-proprietary/uboot-firmware/imx8q/mx8qm-scfw-tcm.bin $(scfw)
...
$(seco):
	...
	cp /home/david/Documents/PARA/1-Projects/wipro/imx8qm/android-build/android_build/vendor/nxp/imx-seco/firmware/seco/mx8qmb0-ahab-container.img $(seco)
...
nxp_mkimage_repo:=https://github.com/nxp-imx/imx-mkimage.git
...
$(flash_image): $(nxp_mkimage) $(scfw) $(seco) $(atf_image) $(uboot_image)
	...
	cd $(nxp_mkimage) && $(MAKE) SOC=iMX8QM flash_spl
	cp $(nxp_mkimage)/iMX8QM/flash.bin $@

# override default linux repo and version
linux_repo:=https://github.com/nxp-imx/linux-imx.git
